...
const infoWindow = (map, place, city, placePos) => {
  var iwContent = `<div style="padding:5px;" className = "map-info-box">${place.name}<div>주소 : ${place.address}</div></div>`, // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
